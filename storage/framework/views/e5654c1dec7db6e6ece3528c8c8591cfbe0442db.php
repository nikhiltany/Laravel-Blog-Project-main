...
<div  style="height:100px; width:1280px; margin-left:90px; margin-top:10px; margin-bottom:20px; color:#f875aa;  padding:20px 20px 20px 20px; background-color:#f4f9f9; float=left">
    <h1 style='font-family:Berlin Sans FB'><center>WELCOME <?php echo e(session('user')); ?></center></h1></div>
...
<?php echo $__env->make('sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sandy\Desktop\Laravel-Blog-Project-main\resources\views/dashboard.blade.php ENDPATH**/ ?>